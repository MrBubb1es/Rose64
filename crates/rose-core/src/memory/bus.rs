...
impl MemoryAccess for Bus {
    fn read8(&self, paddr: u32) -> u8 {
        match paddr {
            0x00000000..=0x003FFFFF => self.rdram.read8(paddr), /* RDRAM */
            0x00400000..=0x007FFFFF => self.rdram.read8(paddr), /* RDRAM (Expansion Pak) */
    ...
    fn read16(&self, paddr: u32) -> u16 {
        match paddr {
            0x00000000..=0x003FFFFF => self.rdram.read16(paddr), /* RDRAM */
            0x00400000..=0x007FFFFF => self.rdram.read16(paddr), /* RDRAM (Expansion Pak) */
            0x00800000..=0x03EFFFFF => 0, /* Unused */
            0x03F00000..=0x03FFFFFF => 0, /* TODO: RDRAM Registers */
            0x04000000..=0x04000FFF => 0, /* TODO: SP DMEM */
            0x04001000..=0x04001FFF => 0, /* TODO: SP IMEM */
    ...
    fn read32(&self, paddr: u32) -> u32 {
        match paddr {
            0x00000000..=0x003FFFFF => self.rdram.read32(paddr), /* RDRAM */
            0x00400000..=0x007FFFFF => self.rdram.read32(paddr), /* RDRAM (Expansion Pak) */
            0x00800000..=0x03EFFFFF => 0, /* Unused */
            0x03F00000..=0x03FFFFFF => 0, /* TODO: RDRAM Registers */
            0x04000000..=0x04000FFF => 0, /* TODO: SP DMEM */
            0x04001000..=0x04001FFF => 0, /* TODO: SP IMEM */
    ...
    fn write8(&mut self, paddr: u32, value: u8) {
        match paddr {
            0x00000000..=0x003FFFFF => self.rdram.write8(paddr, value), /* RDRAM */
            0x00400000..=0x007FFFFF => self.rdram.write8(paddr, value), /* RDRAM (Expansion Pak) */
    ...
    fn write16(&mut self, paddr: u32, value: u16) {
        match paddr {
            0x00000000..=0x003FFFFF => self.rdram.write16(paddr, value), /* RDRAM */
            0x00400000..=0x007FFFFF => self.rdram.write16(paddr, value), /* RDRAM (Expansion Pak) */
            0x00800000..=0x03EFFFFF => {}, /* Unused */
            0x03F00000..=0x03FFFFFF => {}, /* TODO: RDRAM Registers */
            0x04000000..=0x04000FFF => {}, /* TODO: SP DMEM */
            0x04001000..=0x04001FFF => {}, /* TODO: SP IMEM */
    ...
    fn write32(&mut self, paddr: u32, value: u32) {
        match paddr {
            0x00000000..=0x003FFFFF => self.rdram.write32(paddr, value), /* RDRAM */
            0x00400000..=0x007FFFFF => self.rdram.write32(paddr, value), /* RDRAM (Expansion Pak) */
            0x00800000..=0x03EFFFFF => {}, /* Unused */
            0x03F00000..=0x03FFFFFF => {}, /* TODO: RDRAM Registers */
            0x04000000..=0x04000FFF => {}, /* TODO: SP DMEM */
            0x04001000..=0x04001FFF => {}, /* TODO: SP IMEM */
